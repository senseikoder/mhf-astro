            ...
            <div class="content">
               <form @submit.prevent="handleSubmit" class="p-4">
                  <div class="columns is-multiline">
                     ...
                     <div class="column is-6">
                        <div class="select">
                           <select v-model="town" :placeholder="form.labeltown">
                              <option value="">{{ form.labeltown }}</option>
                     ...
                     <div class="column is-6">
                        <div class="select">
                           ...
                           <select v-model="eligible" :placeholder="form.labeleligible">
                              <option value="">{{ form.labeleligible }}</option>
                     ...
                     <div class="column is-6">
                        <div class="select">
                           ...
                           <select v-model="relation" :placeholder="form.labelrelation">
                              <option value="">{{ form.labelrelation }}</option>
                              <option :value="form.labelDaughter">{{ form.labelDaughter }}</option>
                              <option :value="form.labelSon">{{ form.labelSon }}</option>
                              <option :value="form.labelSpouse">{{ form.labelSpouse }}</option>
                              <option :value="form.labelMother">{{ form.labelMother }}</option>
                              <option :value="form.labelFather">{{ form.labelFather }}</option>
                              <option :value="form.labelGrandchild">{{ form.labelGrandchild }}</option>
                              <option :value="form.labelSister">{{ form.labelSister }}</option>
                              <option :value="form.labelBrother">{{ form.labelBrother }}</option>
                              <option :value="form.labelPatient">{{ form.labelPatient }}</option>           
                              <option :value="form.labelOther">{{ form.labelOther }}</option>
                           </select>
                        </div>
                     </div>
...
const form = ref({
   labeltown: idioma.value === '/en' ? "Select your Town" : "Seleccione su Ciudad",
   ...
   labelrelation: idioma.value === '/en' ? "What's your relationship?" : "¿Cuál es su relación?",
   labeleligible: idioma.value === '/en' ? "Is eligible for Medicaid?" : "¿Elegible para Medicaid?",
   labelDaughter: idioma.value === '/en' ? "Daughter" : "Hija",
   labelSon: idioma.value === '/en' ? "Son" : "Hijo",
   labelMother: idioma.value === '/en' ? "Mother" : "Madre",
   labelFather: idioma.value === '/en' ? "Father" : "Padre",
   labelBrother: idioma.value === '/en' ? "Brother" : "Hermano",
   labelSister: idioma.value === '/en' ? "Sister" : "Hermana",
   labelSpouse: idioma.value === '/en' ? "Spouse" : "Cónyuge",
   labelGrandchild: idioma.value === '/en' ? "Grandchild" : "Nieto/a",
   labelPatient: idioma.value === '/en' ? "Patient" : "Paciente",
   labelOther: idioma.value === '/en' ? "Other" : "Otro"
})
...
<p><b>${form.value.labeltown}:</b> ${town.value}</p>
<p><b>${form.value.labelname}:</b> ${name.value}</p>
<p><b>${form.value.labelphone}:</b> ${phone.value}</p>
<p><b>${form.value.labelemail}:</b> ${email.value}</p>
<p><b>${form.value.labeleligible}:</b> ${eligible.value}</p>
<p><b>${form.value.labelrelation}:</b> ${relation.value}</p>
<br><br>
